...
export default function LivraisonDashboardDetails() {
            ...
            <div className="container p-6 px-6 mx-auto bg-white dark:bg-gray-800">
                ...
                <div className="flex flex-wrap my-12 dark:text-white">
                    ...
                    <div className="w-full p-8 md:w-1/2 lg:w-1/3">
                        ...
                        <p className="leading-loose text-gray-500 dark:text-gray-200 text-md">
                        Granular permission management, real-time tracking, automated secure SMS delivery, detailed statistics and reports, automatic parcel retention time calculation, centralized interface, administration of users and deliveries.
                        </p>
                    </div>
                </div>
