...
export default function MonApplicationDetails() {
            ...
            <div className="container p-6 px-6 mx-auto bg-white dark:bg-gray-800">
                <div className="mb-16 text-center">
                    ...
                    <p className="mt-2 text-3xl font-extrabold leading-8 tracking-tight text-gray-600 dark:text-white sm:text-4xl">
                        monnapplication.tech
                    </p>
                </div>
                <div className="flex flex-wrap my-12 dark:text-white">
                    <div className="w-full p-8 border-b md:w-1/2 md:border-r lg:w-1/3">
                        <div className="flex items-center mb-6">
                            <svg width="20" height="20" fill="currentColor" className="w-6 h-6 text-pink-400" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
