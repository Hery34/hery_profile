        ...
        <div className="px-4  py-32 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <div className="mx-auto sm:text-center lg:max-w-2xl">
                <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                    <div>
                        <p className="inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider text-pink-600 last:uppercase rounded-full bg-teal-accent-400">
                            www.monapplication.tech
                        </p>
                    </div>
                    ...
                    Custom applications for ambitious businesses
                    </p>
                </div>
                <div className="mb-4 transition-shadow duration-300 hover:shadow-xl lg:mb-6">
                    <img
                        className="object-scale-down w-full h-56 rounded shadow-lg sm:h-64 md:h-80 lg:h-96"
                        src="/monapplication.png"
                        alt=""
                    />
                </div>
                <p className="max-w-xl mb-4 text-base text-white sm:mx-auto">
                A comprehensive approach to creating tailor-made web and mobile applications, 
                from simple showcase websites to complex business tools with advanced features and seamless integrations.
                </p>
                <div className="flex items-center justify-center">
                    <a
                        href="https://www.monapplication.tech/"
                        target="_blank"
