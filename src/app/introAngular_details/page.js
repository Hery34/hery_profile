...
export default function IntroAngular() {
    return (
                ...
                <div className="flex flex-wrap my-12 dark:text-white">
                    <div className="w-full p-8 border-b md:w-1/2 md:border-r lg:w-1/3">
                        ...
                        <p className="leading-loose text-gray-500 dark:text-gray-200 text-md">
                            December 2023 and still running...
                        </p>
                    </div>
                    ...
                    <div className="w-full p-8 border-b md:w-1/2 md:border-r lg:w-1/3 lg:border-r-0">
                        ...
                        <p className="leading-loose text-gray-500 dark:text-gray-200 text-md">
                            React, Next JS, Tailwind CSS, Maven , Hibernates
                        </p>
                    </div>
                    <div className="w-full p-8 border-b md:w-1/2 lg:w-1/3 lg:border-r lg:border-b-0">
                        ...
                        <p className="leading-loose text-gray-500 dark:text-gray-200 text-md">
                            Java using Maven and Hibernates
                        </p>
                    </div>
                    ...
                    <div className="w-full p-8 md:w-1/2 lg:w-1/3">
                        ...
                        <p className="leading-loose text-gray-500 dark:text-gray-200 text-md">
                            Authentication, administration, profile management, product management, price calculation, payment management...
                        </p>
                    </div>
                </div>
                <div className="flex justify-center">
                    <a href="https://github.com/Hery34/hery_profile" target="_blank">
