...
export default function MmbDetails() {
            ...
            <div className="container p-6 px-6 mx-auto bg-white dark:bg-gray-800">
                ...
                <div className="flex flex-wrap my-12 dark:text-white">
                    ...
                    <div className="w-full p-8 border-b md:w-1/2 lg:w-1/3 lg:border-r lg:border-b-0">
                        ...
                        <p className="leading-loose text-gray-500 dark:text-gray-200 text-md">
                            Sqlflite and SQL deployed on user Mobile
                        </p>
                    </div>
                    ...
                    <div className="w-full p-8 md:w-1/2 lg:w-1/3">
                        ...
                        <p className="leading-loose text-gray-500 dark:text-gray-200 text-md">
                            Implementation of a mobile-generated database using SQLite, CRUD operations on sites and boxes with data validation and error handling, development of a highly precise business logic, and data export to Excel or CSV via Share_plus
                        </p>
                    </div>
                </div>
