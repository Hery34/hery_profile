        ...
        <div className=" bg-gradient-to-tl from-zinc-900/0 via-zinc-900 to-zinc-900/0">
            ...
            <div className="container p-6 px-6 mx-auto bg-white dark:bg-gray-800">
                <div className="mb-16 text-center">
                    ...
                    <p className="mt-2 text-3xl font-extrabold leading-8 tracking-tight text-blue-800 dark:text-white sm:text-4xl">
                        French_population_app
                    </p>
                </div>
                <div className="flex flex-wrap my-12 dark:text-white">
                    <div className="w-full p-8 border-b md:w-1/2 md:border-r lg:w-1/3">
                        <div className="flex items-center mb-6">
                            <svg width="20" height="20" fill="currentColor" className="w-6 h-6 text-blue-800" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="w-full p-8 md:w-1/2 lg:w-1/3">
                        ...
                        <p className="leading-loose text-gray-500 dark:text-gray-200 text-md">
                            Interactive and asynchronized demo using react hook and fully responsive
                        </p>
                    </div>
                </div>
                <div className="flex justify-center">
                    <a href="https://github.com/Hery34/carte_france" target="_blank">
