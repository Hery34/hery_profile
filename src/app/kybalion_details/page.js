...
export default function KybalionDetails() {
                ...
                <div className="flex flex-wrap my-12 dark:text-white">
                    <div className="w-full p-8 border-b md:w-1/2 md:border-r lg:w-1/3">
                        <div className="flex items-center mb-6">
                            <svg width="20" height="20" fill="blue-600" className="w-6 h-6 text-zinc-400" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className="leading-loose text-gray-500 dark:text-gray-200 text-md">
                            January 2025 - Still in improvement
                        </p>
                    </div>
