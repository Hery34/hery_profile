    ...
    return (
        ...
        <main className="relative h-screen overflow-hidden font-mono bg-white dark:bg-gray-800">
            <div className="absolute hidden md:block -bottom-32 -left-32 w-96 h-96">
                <div className="absolute z-20 text-xl text-green-700 text-extrabold right-12 text-start top-1/4">
                    ...
                    <a href="mailto:hery.rakotomanana@etik.com" className="underline">
                        Let&#x27;s talk
                    </a>
                </div>
            ...
            <header className="z-30 flex items-center w-full h-24 sm:h-32">
                <div className="container flex items-center justify-between px-6 mx-auto">
                    <div className="flex items-center text-3xl font-black text-pink-700 dark:text-white">
            ...
            <div className="relative z-20 flex items-center">
                <div className="container relative flex flex-col items-center justify-between px-6 py-4 mx-auto">
                    <div className="flex flex-col">
                        <img src="hery.png" className="mx-auto rounded-full w-28" />
                        <p className="my-6 text-3xl text-center dark:text-white">
                            Hi, I&#x27;m Hery 🤘
                        </p>
                        <h2 className="max-w-3xl py-2 mx-auto text-5xl font-bold text-center text-purple-600 md:text-6xl dark:text-white">
                            And I can also burst with colors
                        </h2>
                        <div className="flex items-center justify-center mt-4">
                            <a href="mailto:me@hery.website" className="px-4 py-2 my-2 text-blue-800 uppercase bg-transparent border-2 border-blue-200 md:mt-16 dark:bg-white hover:dark:bg-gray-100 dark:text-white hover:bg-gray-800 hover:text-white text-md">
                                CONNECT WITH ME
                            </a>
                        </div>
                    </div>
